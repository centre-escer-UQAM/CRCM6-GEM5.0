...
MODELUTILS_LIBS_OTHER_NOSTUBS_0 = $(LIBMUTMG_0) $(MODELUTILS_IFORT_LIB_0)
MODELUTILS_LIBS_OTHER_0  = $(LIBMUSTUBS_0) $(MODELUTILS_LIBS_OTHER_NOSTUBS_0)
...
MODELUTILS_LIBS_ALL_NOSTUBS_0   = $(MODELUTILS_LIBS_MERGED_0) $(MODELUTILS_LIBS_OTHER_NOSTUBS_0)
...
MODELUTILS_LIBS_NOSTUBS_0       = $(MODELUTILS_LIB_MERGED_NAME_0) $(MODELUTILS_LIBS_OTHER_NOSTUBS_0)
...
MODELUTILS_LIBS_OTHER_NOSTUBS  = $(foreach item,$(MODELUTILS_LIBS_OTHER_NOSTUBS_0),$(item)$(MODELUTILS_SFX))
...
MODELUTILS_LIBS_ALL_NOSTUBS    = $(foreach item,$(MODELUTILS_LIBS_ALL_NOSTUBS_0),$(item)$(MODELUTILS_SFX))
...
MODELUTILS_LIBS_NOSTUBS        = $(foreach item,$(MODELUTILS_LIBS_NOSTUBS_0),$(item)$(MODELUTILS_SFX))
...
MODELUTILS_LIBS_OTHER_NOSTUBS_V  = $(foreach item,$(MODELUTILS_LIBS_OTHER_NOSTUBS),$(item)_$(MODELUTILS_VERSION))
...
MODELUTILS_LIBS_ALL_NOSTUBS_V    = $(foreach item,$(MODELUTILS_LIBS_ALL_NOSTUBS),$(item)_$(MODELUTILS_VERSION))
...
MODELUTILS_LIBS_NOSTUBS_V        = $(foreach item,$(MODELUTILS_LIBS_NOSTUBS),$(item)_$(MODELUTILS_VERSION))
