...
subroutine soilWaterPhaseChg (TBAR, THLIQ, THICE, HCP, TBARW, HMFG, HTC, & ! Formerly TWCALC
  ...
  !!
print *,'soilWaterPhaseChg AAA TBAR:',TBAR(IL1:IL2,1)
print *,'soilWaterPhaseChg AAA TBAR(15,1):',TBAR(15,1)
  do J = 1,IG ! loop 100
    do I = IL1,IL2
          ...
          if ((THLIQ(I,J) - THLMIN(I,J) - THEVAP) > 0.0) then
            if (THFREZ <= (THLIQ(I,J) - THLMIN(I,J) - THEVAP)) then
              ...
              TBAR (I,J) = - HADD / (HCP(I,J) * DELZW(I,J) + HCPSND * &
                           (DELZZ(I,J) - DELZW(I,J)))
if (i==15 .and. j==1) &
print *,'soilWaterPhaseChg BBB TBAR:',TBAR (I,J)
            end if
          end if
        end if
        !
        ...
        if (TBAR(I,J) > 0. .and. THICE(I,J) > 0.) then
          ...
          if (THMELT <= THICE(I,J)) then
            ...
            TBAR (I,J) = HADD / (HCP(I,J) * DELZW(I,J) + HCPSND * &
                         (DELZZ(I,J) - DELZW(I,J)))
if (i==15 .and. j==1) &
print *,'soilWaterPhaseChg CCC TBAR:',TBAR (I,J)
          end if
        end if
        !>
...
print *,'soilWaterPhaseChg ZZZ TBARW:',TBARW(IL1:IL2,1)
print *,'soilWaterPhaseChg ZZZ TBARW(15,1):',TBARW(15,1)
  !
  return
