...
!                                                                               !
!  This module contains the 2-moment version of the Milbrandt-Yau microphysics  !
!  scheme (MY2), along with all associated subprograms.                         !
!                                                                               !
!  For questions, bug reports, etc. pertaining to the scheme, or to request     !
!  updates to the code please contact Jason Milbrandt (Environment Canada):     !
!  jason.milbrandt@canada.ca                                                    !
!                                                                               !
!_______________________________________________________________________________!
!                                                                               !
...
! -- OUTPUT: --
!
! massFlux_bot    mass flux at lowest level (for compute sedimentation rate) [kg m-2 s-1]
!
! -- INPUT/OUTPUT: --
!
...
!------------------------------------------------------------------------------!
  ...
  real, parameter :: T0     = 273.15     ![K] ref. temp.
