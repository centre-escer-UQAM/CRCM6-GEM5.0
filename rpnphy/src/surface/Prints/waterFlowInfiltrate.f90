...
subroutine waterFlowInfiltrate (IVEG, THLIQ, THICE, TBARW, BASFLW, TBASFL, & ! Formerly GRINFL
  ...
  !!
!print *,'waterFlowInfiltrate AAA TBARW:',TBARW(IL1:IL2,1)
  do J = 1,IG ! loop 100
    do I = IL1,IL2
      if (IGRN(I) > 0) then
...
!print *,'waterFlowInfiltrate i,j,TBARW,TBARWX,TBARWX(I,1):',i,j,TBARW(I,J),TBARWX(I,J),TBARWX(I,1)
        DELZX(I,J) = DELZW(I,J)
        ZBOTX(I,J) = ZBOTW(I,J)
        FDT (I,J) = 0.0
        TFDT(I,J) = 0.0
...
!print *,'waterFlowInfiltrate BBB TBARWX:',TBARWX(IL1:IL2,1)
  !
  !>
...
!print *,'waterFlowInfiltrate CCC TBARWX:',TBARWX(IL1:IL2,1)
  !
  !>
  ...
  !
!print *,'waterFlowInfiltrate DDD TBARWX:',TBARWX(IL1:IL2,1)
!print *,'waterFlowInfiltrate DDD TMOVE :',TMOVE (IL1:IL2,1)
  ...
  !     * INFILTRATION.
  !
!print *,'waterFlowInfiltrate EEE TBARWX:',TBARWX(IL1:IL2,1)
!print *,'waterFlowInfiltrate EEE TMOVE :',TMOVE (IL1:IL2,1)
  ...
  !
!print *,'waterFlowInfiltrate FFF TBARWX:',TBARWX(IL1:IL2,1)
!print *,'waterFlowInfiltrate FFF TMOVE :',TMOVE (IL1:IL2,1)
...
!print *,'waterFlowInfiltrate GGG TBARWX:',TBARWX(IL1:IL2,1)
!print *,'waterFlowInfiltrate GGG TMOVE :',TMOVE (IL1:IL2,1)
  !
  do J = 1,IG ! loop 800
    do I = IL1,IL2
      if (IGRN(I) > 0) then
  ...
  !
!print *,'waterFlowInfiltrate HHH TBARWX:',TBARWX(IL1:IL2,1)
...
!print *,'waterFlowInfiltrate ZZZ TBARWX:',TBARWX(IL1:IL2,1)
  !
  return
