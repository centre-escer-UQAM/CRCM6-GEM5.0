...
#include <arch_specific.hf>
      ...
      real*8,dimension(Minx:Maxx,Miny:Maxy,1:F_nk):: pr_m_8,pr_t_8
      real*8,dimension(Minx:Maxx,Miny:Maxy)       :: pr_p0_1_8,pr_p0_0_8,pr_fl_w_8,pr_p0_w_8
      real,  dimension(Minx:Maxx,Miny:Maxy,1:F_nk):: sumq
      ...
      if (Schm_psadj==2) then
         ...
         call dry_sfc_pressure_8 (pr_p0_w_8,pr_m_8,pr_p0_1_8,Minx,Maxx,Miny,Maxy,F_nk,'P')

         pr_p0_w_8(1+pil_w:l_ni-pil_e,1+pil_s:l_nj-pil_n) = pr_p0_w_8(1+pil_w:l_ni-pil_e,1+pil_s:l_nj-pil_n) + Cstv_pref_8

      !Compute wet surface pressure on CORE
      !------------------------------------
      else

         pr_p0_w_8(1+pil_w:l_ni-pil_e,1+pil_s:l_nj-pil_n) = pr_p0_1_8(1+pil_w:l_ni-pil_e,1+pil_s:l_nj-pil_n)
      ...
      do n = 1,MAX_iteration
         ...
         if (Schm_psadj==2) then
            ...
            call dry_sfc_pressure_8 (pr_p0_w_8,pr_m_8,pr_p0_0_8,Minx,Maxx,Miny,Maxy,F_nk,'M')
         ...
         !------------------------------------
            ...
            pr_p0_w_8(1+pil_w:l_ni-pil_e,1+pil_s:l_nj-pil_n) = pr_p0_0_8(1+pil_w:l_ni-pil_e,1+pil_s:l_nj-pil_n)
