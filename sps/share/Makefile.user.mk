...
## Optionally for sps the following options can also be modified
##
## For details on SPS additional Makefile variables see:
...
## make modelutils_libs rpnphy_libs sps_libs  #mandatory
## make allbin_modelutils allbin_rpnphy allbin_sps
