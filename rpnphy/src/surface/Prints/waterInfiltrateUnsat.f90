...
print *,'waterInfiltrateUnsat AAA TR:',TR(IL1:IL2)
  do I = IL1,IL2
    IFIND(I) = 0
    WADJ(I) = 0.
  end do ! loop 50
...
print *,'waterInfiltrateUnsat AAA TMOVE:',TMOVE(IL1:IL2,1)
  !
  !>
...
print *,'waterInfiltrateUnsat BBB TMOVE:',TMOVE(IL1:IL2,1)
  !>
...
print *,'waterInfiltrateUnsat CCC TMOVE:',TMOVE(IL1:IL2,1)
  !
  !>
...
print *,'waterInfiltrateUnsat DDD TMOVE:',TMOVE(IL1:IL2,1)
  !>
