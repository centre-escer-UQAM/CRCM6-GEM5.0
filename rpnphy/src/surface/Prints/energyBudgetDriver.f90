...
subroutine energyBudgetDriver (TBARC, TBARG, TBARCS, TBARGS, THLIQC, THLIQG, & ! Formerly CLASST
  ...
  !
  !     * JUL 15/20 - K.Winger.   TSURF CALCULATION PUT BACK IN.
  ...
  real, intent(out) :: TSURF (ILG) !< Diagnosed surface temperature [K]
  ...
  if (NLANDGS > 0) then
    ...
    call snowHeatCond(GCOEFFS, GCONSTS, CPHCHG, IWATER, & ! Formerly TSPREP
                      ...
                      ILG, IL1, IL2, JL)
    ISNOW = 1
print *,'energyBudgetDriver AAA QMELTG:',QMELTG
...
print *,'energyBudgetDriver BBB QMELTG:',QMELTG
    !
...
print *,'energyBudgetDriver CCC QMELTG:',QMELTG
