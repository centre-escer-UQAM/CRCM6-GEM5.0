      BLOCK DATA CLASSBD
C
c     * JUL 06/16 - L.DUARTE    ADD IFRSOIL SWITCH
C     * JAN 28/09 - B.Dugas     Add VAMIN initialization
C     * FEB 06/07 - D.VERSEGHY. NEW VALUE FOR ALVSO AND ALIRI.
C     * MAI 18/06 - V.FORTIN    ADAPT TO RPN PHYSICS (IMPLEMENTED
C                               BY L.DUARTE ON OCT 28/08)
