  ...
  do J = 1,IG ! loop 200
    do I = IL1,IL2
      if (FI(I) > 0. .and. DELZW(I,J) > 0. .and. ISAND(I,1) > - 4) &
          then
!print *,'waterUpdates i,j,HTC,FI:',i,j,HTC(I,J),FI(I)
!print *,'waterUpdates TBARW:',TBARW(I,J)
!print *,'waterUpdates TBAR :',TBAR(I,J)
!print *,'waterUpdates TFREZ,HCPW,HCPICE,DELT:',TFREZ,HCPW,HCPICE,DELT
!print *,'waterUpdates THLIQ:',THLIQ(I,J)
!print *,'waterUpdates THICE:',THICE(I,J)
